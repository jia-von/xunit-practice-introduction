...
## Approach
 ...
 - A solution and console application was created with a name ***XUnitIntroPractice***.
 - A second XUnit Test project was created with solution name ***XUnitTestProject1***.
